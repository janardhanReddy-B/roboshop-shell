...
echo -e "\e[33mADDED PAYMENT CONTENT\e[0m"
curl -L -o /tmp/payment.zip https://roboshop-artifacts.s3.amazonaws.com/payment.zip &>>/tmp/roboshop.log
cd /app

echo -e "\e[33mUNZIP PAYMENT CONTENT\e[0m"
unzip /tmp/payment.zip &>>/tmp/roboshop.log
cd /app

echo -e "\e[33mINSTALLING PIP3 AND REQUIREMENTS\e[0m"
pip3.6 install -r requirements.txt &>>/tmp/roboshop.log

echo -e "\e[33mCOPYING PAYMENT SERVICE\e[0m"
cp /home/centos/roboshop-shell/payment.service /etc/systemd/system/payment.service &>>/tmp/roboshop.log

echo -e "\e[33mSTARTING PAYMENT\e[0m"
